...
session_start();
    ...
    $tampil_tickmill = query("SELECT * FROM data_tickmill ORDER BY id DESC");
?>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <?php foreach ($tampil_tickmill as $row ) : ?> 
                                        <tr>
                                            ...
                                            $query = query("SELECT * FROM data_tickmill WHERE id='$idbukti'");
                                            ...
                                            <td class="actions">
                                                <a href="add/tickmill/accept.php?id=<?= $row["id"] ?>" >
                                                    <span class="badge bg-cyan"><i class="material-icons">done</i></span> 
                                                </a> ||
                                                <a href="add/tickmill/cancel.php?id=<?= $row["id"] ?>" onClick="if(confirm('Apakah anda yakin ?')){return true}else{return false}" >
                                                    <span class="badge bg-orange"><i class="material-icons">close</i></span>
                                                </a> ||
                                                <a href="add/tickmill/delete.php?id=<?= $row["id"] ?>" onClick="if(confirm('Apakah anda yakin ingin menghapusnya ?')){return true}else{return false}" >
