...
session_start();
    ...
    $juhal = "postartikel";
    $promo = query("SELECT * FROM promo ORDER BY id DESC");

//cek apakah tombol submit sudah di tekan atau belum
if( isset($_POST["postingpromo"]) ) {
    

    //cek apakh data berhasil di tambahkan
    if( postpromo($_POST) > 0 ) {
        echo "          
            <script>
            ...
            <div class="block-header">
                                ...
                                <form class="form-horizontal" action=""  method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="judul" name="judul" class="form-control" placeholder="Promo">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-1 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                            <button type="submit" name="postingpromo" class="btn btn-primary m-t-15 waves-effect" >Posting Promo</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Daftar Posting Promo</h2>
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        <form class="form-horizontal" action=""  method="post" >
                                        <button type="submit" name="ppromo" class="btn btn-primary m-t-15 waves-effect" >Posting Promo</button>
                                        </form>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <?php $i = 1; ?>
                                     <?php foreach ($promo as $row ) : ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <a href="editpromo.php?id=<?= $row["id"] ?>" >
                                                    <span class="badge bg-cyan"><i class="material-icons">mode_edit</i></span> 
                                                </a> ||
                                                <a href="add/hapuspromosi.php?id=<?= $row["id"] ?> " onClick="if(confirm('Apakah anda yakin akan menghapus data ?')){return true}else{return false}" class="on-default remove-row" class="on-default remove-row">
