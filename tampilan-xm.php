...
session_start();
    ...
    $tampil_xm = query("SELECT * FROM data_xm ORDER BY id DESC");
?>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <?php foreach ($tampil_xm as $row ) : ?> 
                                        <tr>
                                            ...
                                            $query = query("SELECT * FROM data_xm WHERE id='$idbukti'");
                                            ...
                                            <td class="actions">
                                                <a href="add/xm/accept.php?id=<?= $row["id"] ?>" >
                                                    <span class="badge bg-cyan"><i class="material-icons">done</i></span> 
                                                </a> ||
                                                <a href="add/xm/cancel.php?id=<?= $row["id"] ?>" onClick="if(confirm('Apakah anda yakin ?')){return true}else{return false}" >
                                                    <span class="badge bg-orange"><i class="material-icons">close</i></span>
                                                </a> ||
                                                <a href="add/xm/delete.php?id=<?= $row["id"] ?>" onClick="if(confirm('Apakah anda yakin ingin menghapusnya ?')){return true}else{return false}" >
