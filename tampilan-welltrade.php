...
session_start();
    ...
    $nama_broker = "welltrade";
    $tampil_welltrade = query("SELECT * FROM data_fbs WHERE nama_broker = '$nama_broker' ORDER BY id DESC");
?>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <!-- filter untuk nama broker -->
                                <input type="hidden" name="broker" value="welltrade">
                            <!--  -->
