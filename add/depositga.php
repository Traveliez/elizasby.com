...
$wp = query("SELECT * FROM deposit WHERE id = $idd") [0];
    ...
    if(  mysqli_affected_rows($conn) > 0 ) {
        ...
        //ambil data dari tabel validasi
            ...
            if ($affiliasi==="rti") {
                require '../classes/dgrti.php';
            }elseif ($affiliasi==="oeangkoe"){
                require '../classes/dgoeangkoe.php';
            }else{
                require '../classes/dg.php';
            }
            ...
            $to = $cEmail;
            $SubjectMsg = "Deposit Akun Trading Gagal";
            $bodyMsg = $message;
            ...
            if ($affiliasi==="rti") {
              ...
              {
                        echo '
                    <script> alert("Notifikasi deposit gagal berhasil di kirim"); 
                            document.location.href = "../deposit";
                    </script>
                    ';
